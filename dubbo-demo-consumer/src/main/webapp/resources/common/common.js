...
// isNotWildcard 静态方法;  
// ----------------------------------  
function isNotWildCard(value, expression) {  
...
// ----------------------------------  
function convertDaysToInteger(value) {  
    var v = value;  
...
// ----------------------------------  
function convertMonthsToInteger(value) {  
    var v = value;  
...
// ----------------------------------  
function segmentValidator(expression, value, range, segmentName) {  
    var v = value;  
